    ...
    <div className="mt-10  flex justify-center">
      <div className="card lg:w-[400px] w-[350px] border-2 bg-white shadow-xl">
        ...
        <div className="card-body px-3 items-center text-center">
          ...
          <p>
            If a dog chews shoes whose shoes does he og chews shoes whose shoes
            does he choose?
          </p>
          ...
          <div className="mt-6">
            <button className=" bg-blue-700 border rounded-full w-full p-2  ">
              Buy Now
            </button>
            <button className=" mt-4 mb-6  border-2 border-blue-300 rounded-full w-full p-2  ">
              Buy Now
            </button>
          </div>
        </div>
